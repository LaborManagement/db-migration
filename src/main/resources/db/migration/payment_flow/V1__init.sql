...
SELECT auth.apply_std_rls_policy('payment_flow', 'board_master', true, true, 'board_id', NULL);
SELECT auth.apply_std_rls_policy('payment_flow', 'board_receipts', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'employer_payment_receipts', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'employer_toli_relation', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'uploaded_files', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'worker_payment_receipts', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'worker_payments', true, true, 'board_id', 'employer_id');
SELECT auth.apply_std_rls_policy('payment_flow', 'worker_uploaded_data', true, true, 'board_id', 'employer_id');
...
GRANT INSERT, SELECT, UPDATE, DELETE ON payment_flow.toli_details TO app_payment_flow;
