                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     rejection_reason VARCHAR(500),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                board_id BIGINT, employer_id BIGINT, toli_id BIGINT);
...
SELECT,
UPDATE,
DELETE ON payment_flow.worker_payments TO app_payment_flow;
...
Alter TABLE ONLY payment_flow.attendance_data
FORCE ROW LEVEL SECURITY;
...
GRANT USAGE,
SELECT ON SEQUENCE payment_flow.worker_payment_receipts_id_seq TO app_payment_flow;

GRANT USAGE,
SELECT ON SEQUENCE payment_flow.worker_payments_id_seq TO app_payment_flow;
...
ALTER TABLE payment_flow.worker_uploaded_data rename COLUMN month TO year_month;


ALTER TABLE payment_flow.worker_uploaded_data rename COLUMN month TO year_month;


ALTER TABLE payment_flow.worker_uploaded_data ADD COLUMN worker_regno VARCHAR(50);
