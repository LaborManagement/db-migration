...
-- Create application user for reconciliation service (if not exists)
DO $$
BEGIN
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_roles WHERE rolname = 'app_reconciliation') THEN
        CREATE ROLE app_reconciliation LOGIN PASSWORD 'changeme';
    END IF;
END$$;

-- Grant privileges to app_reconciliation
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.bank_account TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.uploaded_files TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.van_file TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.van_transaction TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.transaction_86_segment TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.file_processing_queue TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.import_error TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.import_run TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.raw_statement_line TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.statement_balance TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.statement_file TO app_reconciliation;
GRANT INSERT, SELECT, UPDATE, DELETE ON reconciliation.statement_transaction TO app_reconciliation;

-- Cross-schema grants
GRANT INSERT, SELECT ON audit.audit_event TO app_reconciliation;
GRANT INSERT, SELECT ON audit.entity_audit_event TO app_reconciliation;
