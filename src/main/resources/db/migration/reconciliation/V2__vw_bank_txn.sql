...
GRANT SELECT, INSERT, UPDATE, DELETE ON reconciliation.statement_transaction TO app_clearing;
GRANT SELECT, INSERT, UPDATE, DELETE ON reconciliation.van_transaction TO app_clearing;